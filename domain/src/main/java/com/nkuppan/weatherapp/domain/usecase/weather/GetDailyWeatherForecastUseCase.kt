...
class GetDailyWeatherForecastUseCase(private val repository: WeatherRepository) {

    suspend operator fun invoke(city: City, numberOfDays: Int): Resource<WeatherForecast> {
